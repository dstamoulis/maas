...
# # python3 generate_allops.py --model_name $rmodel --num_samples $rnumsamples --batch_size $rbatchsize --prompt_op ReAct # skipping ReAct
...
# # python3 generate_allops.py --model_name $rmodel --num_samples $rnumsamples --batch_size $rbatchsize --prompt_op ReAct --verilogeval # skipping ReAct
...
# # python3 generate_allops.py --model_name $rmodel --num_samples $rnumsamples --batch_size $rbatchsize --prompt_op ReAct --self_refine # skipping ReAct
...
# # python3 generate_allops.py --model_name $rmodel --num_samples $rnumsamples --batch_size $rbatchsize --prompt_op ReAct --verilogeval --self_refine # skipping ReAct
...
python3 generate_allops.py --model_name $rmodel --num_samples $rnumsamples --batch_size $rbatchsize --prompt_op Generate --verilogeval --self_refine  --resume
python3 generate_allops.py --model_name $rmodel --num_samples $rnumsamples --batch_size $rbatchsize --prompt_op GenerateCoT --verilogeval --self_refine
