...
# # Needed for o4-mini c=20 VerilogEval!
# python3 evaluation_ppa.py --prompt_op GenerateCoT --num_samples 20 --self_refine --model_name o4-mini
# python3 evaluation_ppa.py --prompt_op GenerateCoT --num_samples 20 --self_refine --model_name o4-mini --verilogeval 

# Also!
python3 evaluation_yosys.py --prompt_op GenerateCoT --num_samples 20 --self_refine --model_name o4-mini --verilogeval 
