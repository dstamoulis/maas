...
import maas.ext.maas.scripts.optimized.VeriThoughts.train.template.operator as operator
from maas.ext.maas.scripts.optimized.VeriThoughts.train.template.operator_registry import operator_mapping, operator_names
...
class Workflow:
    ...
    async def __call__(self, problem: str, log_path: str):
        ...
        # TESTING!! DEBUG!! TODO: REMOVE
        # op_name = "MultiGenerateCoT" # "GenerateCoT"]:
        # selected_operator = self.selection_operator_instances[op_name]
        # result = await selected_operator(problem=problem, instruction="")
        # # result = await selected_operator(problem=problem, solution=current_solution)
        # # result = await selected_operator(problem=problem, solutions=solutions)
